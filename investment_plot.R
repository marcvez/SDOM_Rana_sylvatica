...
Invest_plot_final <- function(){
  ...
  minor.tick(nx=0, ny=4)
  
  for (n in 1:N) {
    lines(Tadpole_state[n, 1, ], col = "blue")
    points(Adult[n, 1, ], pch = 19, col = "blue")
    points(Adult[n, 4, ], col = "blue")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 1, ], col = "red")
    points(Adult[n, 1, ], pch = 19, col = "red")
    points(Adult[n, 4, ], col = "red")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 1, ], col = "black")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 2, ], col = "blue")
    points(Adult[n, 2, ], pch = 19, col = "blue")
    points(Adult[n, 5, ], col = "blue")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 2, ], col = "red")
    points(Adult[n, 2, ], pch = 19, col = "red")
    points(Adult[n, 5, ], col = "red")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 2, ], col = "black")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 3, ], col = "blue")
    points(Adult[n, 3, ] - 0.15, pch = 19,  col = "blue")
    points(Adult[n, 6, ], col = "blue")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 3, ], col = "red")
    points(Adult[n, 3, ] - 0.15, pch = 19, col = "red")
    points(Adult[n, 6, ], col = "red")
  ...
  for (n in 1:N) {
    lines(Tadpole_state[n, 3, ], col = "black")
    points(Adult[n, 3,] - 0.15, pch = 19)
    points(Adult[n, 6,])
